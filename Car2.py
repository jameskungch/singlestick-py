...
class sprite():
    ...
    def istouching(self, target):
        ...
        if abs(xdiff) < (self.img_width + target.img_width)/2 and abs(ydiff) < (self.img_height + target.img_width)/2:
            return True
...
def game_loop():
    car = sprite("racecar.png", 640, 400, 5, 5, 73, 82, True, 0.2, 0.995)
    ball = sprite("target.png", 640, 360, 20, 20, 50, 50, True, 0, 0.99)
    enemy = sprite("redsquare.png", 50, 50, 1, 1, 30,30,True, 0, 0)
